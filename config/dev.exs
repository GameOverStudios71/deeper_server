...
config :deeper_server, DeeperServerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "OTRdmYwrh8HaW5M06RWrmFAS2ugy1uqzseW2yniWrg6zdxzovOtBEr3ugot2Ta9Q",
  watchers: [
...
config :deeper_server, :joken,
  secret: "a_very_secret_and_secure_string_for_dev_only"
